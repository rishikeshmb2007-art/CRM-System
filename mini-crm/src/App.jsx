...
function App() {
  ...
  const fetchLeads = () => {
    fetch('https://dashboard.render.com/web/srv-d7fa2mc71suc738k75fg/deploys/dep-d7fa4hjbc2fs739hh4eg?r=2026-04-14%4020%3A22%3A34%7E2026-04-14%4020%3A26%3A03') //Link is added.
      .then(res => res.json())
